...
import 'package:wger/l10n/fallback_localizations.dart' as rwfb;
...
import 'integrations/wear_bridge.dart';
...
class MainApp extends StatelessWidget {
  ...
  WidgetsBinding.instance.addPostFrameCallback((_) {
    final routines = Provider.of<RoutinesProvider>(ctx, listen: false);
    WearBridge().init(auth, routines);
    if (auth.isAuth) {
      WearBridge().sendAuth(auth);
    } else {
      WearBridge().sendLogout();
    }
  });
  return MaterialApp(
            title: 'wger',
            ...
            localizationsDelegates: [
              rwfb.rwMaterialLocalizationDelegate,
              rwfb.rwWidgetsLocalizationDelegate,
              rwfb.rwCupertinoLocalizationDelegate,
